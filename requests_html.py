...
class BaseSession(requests.Session):
    ...
    async def browser(self):
        if not hasattr(self, "_browser"):
            self._browser = await pyppeteer.launch(executablePath='/usr/bin/google-chrome-stable', ignoreHTTPSErrors=not(self.verify), headless=True, args=self.__browser_args)
